...
import (
	...
	"github.com/qiniu/pandora-go-sdk/v2/reqid"
)

var UserAgent = "Golang pandora/client package"
...
func SetAppName(userApp string) error {
	UserAgent = fmt.Sprintf(
		"PandoraGo/%s (%s; %s; %s) %s", conf.Version, runtime.GOOS, runtime.GOARCH, userApp, runtime.Version())
	return nil
}
